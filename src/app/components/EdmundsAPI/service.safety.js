  ...
  function Safety ($log, $http) {
    return {
      ...
      getRatingsByModelYear: function (api_key, vehicle_make, vehicle_model, vehicle_year, params) {
        params = angular.merge(params, { api_key: api_key, fmt: 'json'});
        var url = 'https://api.edmunds.com/api/vehicle/v2/' + vehicle_make + '/' + vehicle_model + '/' + vehicle_year + '/safety';
        return $http({
          method: 'GET',
          url: url,
          params: params
